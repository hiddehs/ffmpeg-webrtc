...
if [[ ! -d $ffmpeg_dir ]]; then
  ...
  git clone --depth 1 -b feature/rtc-muxer https://github.com/hiddehs/ffmpeg-webrtc.git $ffmpeg_dir.tmp.git
...
cd $ffmpeg_dir
  ...
  if [[ ! -f ffbuild/config.mak ]]; then
    ...
    ./configure --enable-gpl --enable-nonfree --enable-version3 --disable-doc --enable-libx264 \
